...
export default class Sorry extends React.Component {
  ...
  render() {
    const { game, player, hasNext, onSubmit } = this.props;
    let msg;
    switch (player.exitStatus) {
      ...
      case "gameLobbyTimedOut":
        msg = "There were not enough players for the game.";
        break;
    ...
    return (
      <Centered>
        <div className="score">
          ...
          <p>Sorry, you were not able to play now! {msg}</p>
          ...
          <p>
            <strong>Please come back for the next scheduled game on: {game.treatment["nextExpDate"]}.</strong>{" "}
