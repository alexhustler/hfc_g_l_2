...
export default {
  ...
  onStageEnd(game, round, stage, players) {
    ...
    players.forEach(player => {
      ...
      player.round.set("playerChoice", value > 50);
      if (thinksWillHappen) {
        yesCount++;
      }
    ...
    const groupCorrect =
      ...
      (correctCount === votedCount / 2 // If half correct (and half incorrect)
        ? Random.choice([true, false]) // Choose randomly if correct
        : correctCount > votedCount / 2)); // Otherwise correct if majority correct
